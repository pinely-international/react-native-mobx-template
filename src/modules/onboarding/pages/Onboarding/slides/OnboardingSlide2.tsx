import { CoolEmojiAnimation } from '@animations/components/CoolEmojiAnimation';
...
export const OnboardingSlide2 = observer(() => {
	...
	return (
		...
		>
			...
			>
				{t('onboarding_slide2_description')}
			</SecondaryText>
		</Animated.View>
	);
});
